...
Meaning: It means a variable has been declared but has not yet been assigned a value.
When it Occurs:
If you declare a variable but do not assign it a value, it is automatically undefined.

    let dataOne;
    console.log(dataOne); //undefined
    console.log(typeof dataOne); //undefined
