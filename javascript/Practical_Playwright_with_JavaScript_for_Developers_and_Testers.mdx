...
#### Problem 1.12: What is difference between null and undefined

#### Problem 1.12: How to add check for null or undefined in code on a variable
...
### Problem 2.16: Comparison and Logical Operators Script: Create a script that compares two number using different comparison operator and combines conditions using logical operators, logging the results

### 2.17: Ternary Operator Script: Write a script that uses the ternary operator to determine if a number is positive or negative and log the results
...
#### Task 1 : Write a function (using function declaration) to check if a number is even or odd and log the result to the console

#### Task 2 : Write a function (using function declaration) to calculate the square of a number and return the result
...
#### Task 10 : What is callback function, why we need it

#### Task 10 : How can one avoid callback hell in JavaScript

#### Task 10 : What is concept of pure function

#### Task 10 : What is difference between function.call, function.apply and function.bind

#### Task 10 : What is the usage of argument object in a function

#### Task 10 : What is closure, why we need it

#### Task 10 : How do you create a closure in JavaScript

#### Task 10 : What is difference between deep copy and shallow copy

#### Task 10 : How does call stack works in JavaScript

#### Task 10 : What is function curring
...
#### Task 9 : Explain difference between Object.create and the constructor pattern

#### Task 9 : How do we prevent modification of object in JavaScript

#### Task 9 : What is new keyword and its usage

#### Task 9 : Explain concept of Object Destructuring in JavaScript
...
### Problem 1: Lis to software required to be installed on your machine to run Playwright

### Problem 1: How to install Playwright

### Problem 1: How to upgrade Playwright

### Problem 1: List of extension required to setup

### Problem 1: How to do tool setup for Playwright

### Problem 1: How to write tests?

### Problem 1: How to run test?

### Problem 1: How to debug tests?

### Problem 1: What is playwright codegen?

### Problem 1: What is playwright inspector?

### Problem 1: How to launch browser (Chrome/Edge/Firefox/Safari)

### Problem 1: How to launch browser based on config value

### Problem 1: How to load URL in browser

### Problem 1: How to minimize, maximize and close the browser

### Problem 1: How to launch multiple browser in single test

### Problem 1: How to perform operation on multiple browser

### Problem 1: How to find element

### Problem 1: What are different locator in playwright

### Problem 1: How to apply custom delay or wait

### Problem 1: How to perform operation on HTML element

### Problem 1: How to read browser console log

### Problem 1: How to read network tabs values

### Problem 1: How to track API calls and their status (status code, request, response) while page is loading

### Problem 1: How to list all API called and capture details when test failed

### Problem 1: How to save browser session details

### Problem 1: How to run data driven test

### Problem 1: What are different annotation in Playwright

### Problem 1: How to use different annotation in Playwright

### Problem 1: How to hit an API in Playwright, verify status code and work on JSON response

### Problem 1: How to hit a GET request using Playwright

### Problem 1: How to hit a POST request using Playwright

### Problem 1: How to hit a DELETE request using Playwright

### Problem 1: How to hit a PUT request using Playwright

### Problem 1: How to hit a PATCH request using Playwright

### Problem 1: How to hit multiple API in a test and use first API respone value in second API

### Problem 1: How to use API and browser action in single test

### Problem 1: What are different reporting available in Playwright

### Problem 1: What is Sharding

### Problem 1: How to run test script on Azure services

### Problem 1: How to generate log file in a Playwright test

### Problem 1: How to intercept API call using Playwright

### Problem 1: How to mock API request using Playwright

### Problem 1: How to modify API response using Playwright

### Problem 1: How to club multiple test in single feature
