...
#### Problem 1.1 : Declare a variable using var, assign it a number and the log the value to the console
    ...
    **Note : ** var is the old way to declaring variables in javascript. Variables declared with var can be reassigned and redeclared within the same scope. It has function scope or global scope(if declared outside of a function)
